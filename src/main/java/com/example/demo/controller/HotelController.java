...
import com.example.demo.servises.HotelService;
import com.example.demo.servises.RoomService;
...
public class HotelController {
	...
	public String getHotelById(@PathVariable Long id, Model model) {
		Hotel hotel = hotelService.getHotelById(id)
				.orElseThrow(() -> new IllegalArgumentException("Invalid hotel id: " + id)); //Lambda features we use
